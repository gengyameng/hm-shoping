<template>
  <div class="prodetail">
    ...
    >
      <van-swipe-item
        v-for="item in images" :key="item.file_id"
      >
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div
          ...
          >
          <div class="top">
            <img :src="item.user.avatar_url || defaultAvatarImg" alt="">
     ...
     <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立刻购买'">
      <div class="product">
        ...
        <div class="showbtn" v-if="detail.stock_total > 0">
          <div class="btn" v-if="mode === 'cart'" @click="addCartHandle">加入购物车</div>
...
export default {
  ...
  methods: {
    ...
    async getComments () {
      ...
      // console.log(list, total)loginConfirm
